...
<nav>
    <div id="fondo1"></div>
    <div id="logo">CARRILLAS DENTALES</div>
    <div id="opcion1" class="Menu">DIENTES NATURALES PERFECTOS.</div>
</nav>
<!--///////////////////////////////////////////////////////////////////////////////////////////-->
<body>
<div class="div_tratamiento">
    ...
    <section>
        ...
        <div class="div_texto">
            <h1>CARRILLAS DENTALES son la solución ideal para lucir los dientes perfectos que siempre soñaste.</h1>
            <p>Ayudan a mejorar la apariencia del diente cambiando su color, forma o tamaño.</p>
            <h2>¿Como se hace?</h2>
            <p>Las carillas dentales son piezas de porcelana o cerámica muy delgadas hechas a las medida. Éstas se adhieren al diente y son utilizadas para recrear una estética dental con aspecto natural.</p>
            <li>Se realiza en una sola sesión de 45 minutos</li>
            <h2>¿Para que sirve?</h2>
            <li>Cambios de color que el blanqueamiento no elimine</li>
            <li>Forma irregular</li>
            <li>Espacios entre los dientes</li>
            <li>Fracturas o fisuras</li>
            <li> Mejora la salud bucal</li>
            <h3>PRECIO: 50BS</h3>
