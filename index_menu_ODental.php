...
<nav>
    <div id="fondo1"></div>
    <div id="logo">ORTODONCIA</div>
    <div id="opcion1" class="Menu">TRATAMIENTO DE ORTODONCIA CORTO, COMODO Y EFICAZ.</div>
</nav>
<!--///////////////////////////////////////////////////////////////////////////////////////////-->
<body>
<div class="div_tratamiento">
    ...
    <section>
        ...
        <div class="div_texto">
            <h1> LA ORTODONCIA te ayuda a corregir los dientes y te da la seguridad de lucir una dentadura perfecta.</h1>
            <p>Los tratamientos de ortodoncia nos ayudan a tener una boca sana, una boca feliz y dientes con más fuerza y una duración larga de vida.</p>
            <h2>¿Cómo funciona?</h2>
            <p>Se utilizan diversos tipos de aparatos, fijos y removibles, para mover los dientes, volver a entrenar los músculos y modificar el crecimiento de las mandíbulas. Estos aparatos funcionan aplicando una presión suave sobre los dientes y los huesos. La severidad del problema deteminará cuál será el enfoque ortodóncico más eficaz. Algunos tipos de aparato son:</p>
            <li>Retenedores de espacio fijos</li>
            <li>Alineadores</li>
            <li>Aparatos fijos especiales</li>
