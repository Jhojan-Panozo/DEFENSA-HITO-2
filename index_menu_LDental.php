...
<nav>
    <div id="fondo1"></div>
    <div id="logo">LIMPIEZA DENTAL</div>
    <div id="opcion1" class="Menu">DIENTES LIMPIOS, EXPRESIONES SEGURAS.</div>
</nav>
<!--///////////////////////////////////////////////////////////////////////////////////////////-->
<body>
<div class="div_tratamiento">
    ...
    <section>
        ...
        <div class="div_texto">
            <h1> LIMPIEZA DENTAL para tener esos dientes blancos que tanto te gustan.</h1>
            <p>Una limpieza dental te ayuda a:</p>
            <li>Prevenir enfermedades de encías y hueso</li>
            <li>Evitar el mal aliento</li>
            <li>Tener dientes sanos</li>
            <h2>¿Qué es?</h2>
            <p>La limpieza dental, también llamada profilaxis, es un procedimiento en el cual tu odontólogo removerá manchas, sarro y placa dentobacteriana para mantener la salud de tus dientes y encías.</p>
            <h2>¿Como se hace?</h2>
            <p>En dentalia® hacemos la limpieza dental usando ultrasonido, que funciona a base de vibración y agua a presión. Este procedimiento se realiza en tan sólo 1 sesión.</p>
            <h3>PRECIO: 50BS</h3>
