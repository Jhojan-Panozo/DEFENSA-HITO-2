...
<nav>
    <div id="fondo1"></div>
    <div id="logo">PERIODONCIA</div>
    <div id="opcion1" class="Menu">ENCIAS SANAS, BOCA FELIZ.</div>
</nav>
<!--///////////////////////////////////////////////////////////////////////////////////////////-->
<body>
<div class="div_tratamiento">
    ...
    <section>
        ...
        <div class="div_texto">
            <h1>LA PERIODONCIA ayudará a recuperar la salud y estética de tus encías.</h1>
            <p>Es necesaria cuando presentas alguno de estos síntomas:</p>
            <li>Sangrado en encías o mal aliento</li>
            <li>Molestia al masticar o al cepillar</li>
            <li>Inflamación y color rojo brillante en las encías</li>
            <h2>¿Qué es?</h2>
            <p>La periodoncia es la especialidad que se encarga de tratar las principales enfermedades de las encías causadas por una mala higiene, como:</p>
            <li>Gingivitis (causa inflamación de las encías)</li>
            <li>Periodontitis (infección de las encías)</li>
            <h2>¿Para que sirve?</h2>
            <li>Tratar la inflamación de las encías</li>
            <li>Ayudar a prevenir la pérdida de hueso y movilidad dental</li>
